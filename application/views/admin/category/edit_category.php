    ...
    <div class="row">
      <div class="col-md-6">
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" method="post" action="<?php echo site_url('admin/edit-category/'.$category->id); ?>">
              <div class="box-body">
                <div class="form-group">
                  <label for="category" class="col-sm-2 control-label">Category</label>

                  <div class="col-sm-10">
                    <input type="text" name="category" id="category" class="form-control" placeholder="Category" value="<?php echo set_value('category', $category->category); ?>">
